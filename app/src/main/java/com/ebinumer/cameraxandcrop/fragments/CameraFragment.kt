package com.ebinumer.cameraxandcrop.fragments
...
import com.ebinumer.cameraxandcrop.R
import com.ebinumer.cameraxandcrop.analyzer.LuminosityAnalyzer
import com.ebinumer.cameraxandcrop.databinding.FragmentCameraBinding
import com.ebinumer.cameraxandcrop.enums.CameraTimer
import com.ebinumer.cameraxandcrop.utils.*
    ...
    private fun closeFlashAndSelect(@FlashMode flash: Int) =
        binding.llFlashOptions.circularClose(binding.btnFlash) {
            ...
            binding.btnFlash.setImageResource(
                when (flash) {
                    FLASH_MODE_ON -> R.drawable.ic_flash_on
                    FLASH_MODE_OFF -> R.drawable.ic_baseline_flash_off_24
